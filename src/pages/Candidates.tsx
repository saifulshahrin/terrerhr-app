...
const CANDIDATE_IDS = ['alice-johnson', 'bob-martinez', 'carol-chen', 'david-kim', 'emily-ross', 'frank-liu'];
...
export default function Candidates() {
  const { candidates, getStage } = useStore();
  const visible = candidates.filter(c => CANDIDATE_IDS.includes(c.id));
    ...
    <div>
      <div className="flex items-center justify-between mb-7">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{visible.length} candidates across all jobs</p>
        </div>
